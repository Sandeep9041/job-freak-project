...
<div className="flex">
  ...
  <form className="pt-16 flex flex-col">
    <label htmlFor="fname" className="text-sm text-slate-800 font-sans pb-0.5">First Name</label>
    ...
    <label htmlFor="lname" className="text-sm text-slate-800 font-sans  pb-0.5">Last Name</label>
    ...
    <label htmlFor="subject" className="text-sm text-slate-800 font-sans  pb-0.5">Message</label>
    ...
    <input type="submit" className="font-sans text-sm rounded bg-slate-950 w-24 h-10 text-white" value="Submit"/>
  </form>
    </div>
    </div>
</div>
